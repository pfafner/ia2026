...
03       | 21.01.2026   | Agentes. Secuencias de percepción. Ejemplos.     | [Descripción de Agentes](actividades/Descripcion_de_Agentes.xlsx){:target="_blank"} <br/> [Clasificación de Ambientes](actividades/Clasificacion_de_Ambientes.xlsx){:target="_blank"} 
